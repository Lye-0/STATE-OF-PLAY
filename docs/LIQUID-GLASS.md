...
v4.15.0で追加した最初の4カテゴリ8作品。v4.16.0では残り33カテゴリへ66作品が加わり、全37カテゴリにA/B各1作品が揃いました。通常のカテゴリ選択とデザインフィルターで表示できます。新しい66作品の導入方法は [GLASS-COLLECTION.md](GLASS-COLLECTION.md) を参照してください。
