...
export function SelectView(props:SelectProps) {
  const {items=[],value,defaultValue,onValueChange,onOpenChange,label='選択してください',placeholder='選択してください',name,disabled=false,renderOption,autoIcon=true,showHeading=true,showHints=true,className='',...attributes}=props;
