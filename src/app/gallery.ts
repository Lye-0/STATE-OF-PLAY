...
async function renderGallery(append = false) {
    ...
    for (const part of visible) {
        ...
        rendered.push({ part, controller, card, surface, cleanup:part.signature ? mountSignatureSample(root,part,controller) : part.foundation ? mountFoundationSample(root,part,controller) : part.category==='popups'?mountPopupSample(root,part):demo?.destroy });
