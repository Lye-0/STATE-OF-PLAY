...
export type InsetTrailProps = FoundationProps;
/** Inset Trail: Bタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, InsetTrailProps>(function InsetTrail(props, ref) {
