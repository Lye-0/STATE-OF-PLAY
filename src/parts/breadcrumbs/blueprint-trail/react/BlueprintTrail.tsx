...
export type BlueprintTrailProps = FoundationProps;
/** Blueprint Trail: Aタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, BlueprintTrailProps>(function BlueprintTrail(props, ref) {
