...
export type SoftTrailProps = FoundationProps;
/** Soft Trail: Bタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, SoftTrailProps>(function SoftTrail(props, ref) {
