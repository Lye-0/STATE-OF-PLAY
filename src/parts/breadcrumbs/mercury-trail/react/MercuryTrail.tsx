...
export type MercuryTrailProps = FoundationProps;
/** Mercury Trail: Aタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, MercuryTrailProps>(function MercuryTrail(props, ref) {
