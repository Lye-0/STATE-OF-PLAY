...
export type CompactTrailProps = FoundationProps;
/** Compact Trail: Bタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, CompactTrailProps>(function CompactTrail(props, ref) {
