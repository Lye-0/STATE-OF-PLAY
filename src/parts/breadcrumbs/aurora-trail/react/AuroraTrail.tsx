...
export type AuroraTrailProps = FoundationProps;
/** Aurora Trail: Aタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, AuroraTrailProps>(function AuroraTrail(props, ref) {
