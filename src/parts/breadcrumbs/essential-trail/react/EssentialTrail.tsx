...
export type EssentialTrailProps = FoundationProps;
/** Essential Trail: Bタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, EssentialTrailProps>(function EssentialTrail(props, ref) {
