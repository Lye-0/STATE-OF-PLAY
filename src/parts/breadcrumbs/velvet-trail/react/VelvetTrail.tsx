...
export type VelvetTrailProps = FoundationProps;
/** Velvet Trail: Aタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, VelvetTrailProps>(function VelvetTrail(props, ref) {
