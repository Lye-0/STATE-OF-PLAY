...
export type PaperTrailProps = FoundationProps;
/** Paper Trail: Bタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, PaperTrailProps>(function PaperTrail(props, ref) {
