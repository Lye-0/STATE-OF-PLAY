...
export type ObsidianTrailProps = FoundationProps;
/** Obsidian Trail: Aタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, ObsidianTrailProps>(function ObsidianTrail(props, ref) {
