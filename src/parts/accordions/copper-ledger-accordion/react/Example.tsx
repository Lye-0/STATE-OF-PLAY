...
{value:"section-2",title:"Surface treatment",subtitle:"表面の仕上げ",badge:"SATIN",content:<> <p>研磨の方向を揃え、光の反射を落ち着かせる。手で触れたときの温度と質感まで設計します。</p><div className="sop-panel-tags"><span>DETAILS</span><span>CRAFT</span><span>REFERENCE</span></div> </>},
