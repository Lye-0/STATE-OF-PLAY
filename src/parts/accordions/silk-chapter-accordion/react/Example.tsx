...
{value:"section-2",title:"Color story",subtitle:"染めの記憶",badge:"DYE",content:<> <p>一度で強く染めず、淡い色を何度も重ねる。奥行きのある色が、日々の暮らしになじんでいきます。</p><div className="sop-panel-tags"><span>DETAILS</span><span>CRAFT</span><span>REFERENCE</span></div> </>},
