...
{value:"section-2",title:"Along the route",subtitle:"途中で立ち寄る",badge:"ROUTE",content:<> <p>川沿いの道、古い書店、小さな喫茶店。目的地だけでなく、道中で見つける場所も記録します。</p><div className="sop-panel-tags"><span>RIVER</span><span>BOOKSHOP</span><span>CAFE</span></div> </>},
