# Capsule Field — 入力可能なテキストボックスの再現仕様

デザイン分類: A。SMOKED / CAPSULE。光を閉じ込めたスモークガラス。目のボタンで入力内容を確認できる。
ことばを、包む。 ネイティブのpassword inputを主役に、読みやすい16px以上の文字と静かなフォーカス反応を維持する。
