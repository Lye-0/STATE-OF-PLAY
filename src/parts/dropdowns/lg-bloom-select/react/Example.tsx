...
export default function Example(){const [sort,setSort]=useState('updated');return <BloomSelect items={items} value={sort} onValueChange={setSort} label="並び順" name="sort"/>;}
