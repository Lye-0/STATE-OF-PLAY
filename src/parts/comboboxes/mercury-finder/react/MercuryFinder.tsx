...
export type MercuryFinderProps = FoundationProps;
/** Mercury Finder: Aタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, MercuryFinderProps>(function MercuryFinder(props, ref) {
