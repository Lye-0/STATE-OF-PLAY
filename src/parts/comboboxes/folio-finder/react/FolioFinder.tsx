...
export type FolioFinderProps = FoundationProps;
/** Folio Finder: Aタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, FolioFinderProps>(function FolioFinder(props, ref) {
