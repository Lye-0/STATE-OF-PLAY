...
export type MonoFinderProps = FoundationProps;
/** Mono Finder: Bタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, MonoFinderProps>(function MonoFinder(props, ref) {
