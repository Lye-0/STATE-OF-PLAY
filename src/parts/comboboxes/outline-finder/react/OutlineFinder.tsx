...
export type OutlineFinderProps = FoundationProps;
/** Outline Finder: Bタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, OutlineFinderProps>(function OutlineFinder(props, ref) {
