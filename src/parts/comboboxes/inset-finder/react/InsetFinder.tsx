...
export type InsetFinderProps = FoundationProps;
/** Inset Finder: Bタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, InsetFinderProps>(function InsetFinder(props, ref) {
