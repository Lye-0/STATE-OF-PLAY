...
export type SoftFinderProps = FoundationProps;
/** Soft Finder: Bタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, SoftFinderProps>(function SoftFinder(props, ref) {
