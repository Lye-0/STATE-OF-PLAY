...
export type ContourFinderProps = FoundationProps;
/** Contour Finder: Aタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, ContourFinderProps>(function ContourFinder(props, ref) {
