...
export type EssentialFinderProps = FoundationProps;
/** Essential Finder: Bタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, EssentialFinderProps>(function EssentialFinder(props, ref) {
