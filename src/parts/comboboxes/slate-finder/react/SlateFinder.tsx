...
export type SlateFinderProps = FoundationProps;
/** Slate Finder: Bタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, SlateFinderProps>(function SlateFinder(props, ref) {
