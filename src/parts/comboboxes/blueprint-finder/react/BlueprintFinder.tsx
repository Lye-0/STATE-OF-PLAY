...
export type BlueprintFinderProps = FoundationProps;
/** Blueprint Finder: Aタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, BlueprintFinderProps>(function BlueprintFinder(props, ref) {
