...
export type CopperFinderProps = FoundationProps;
/** Copper Finder: Aタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, CopperFinderProps>(function CopperFinder(props, ref) {
