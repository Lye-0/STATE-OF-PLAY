...
export type VelvetFinderProps = FoundationProps;
/** Velvet Finder: Aタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, VelvetFinderProps>(function VelvetFinder(props, ref) {
