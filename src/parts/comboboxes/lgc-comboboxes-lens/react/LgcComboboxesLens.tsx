...
export type LgcComboboxesLensProps = FoundationProps;
/** Lens Finder: Bタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, LgcComboboxesLensProps>(function LgcComboboxesLens(props, ref) {
