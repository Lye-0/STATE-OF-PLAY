...
export type ObsidianFinderProps = FoundationProps;
/** Obsidian Finder: Aタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, ObsidianFinderProps>(function ObsidianFinder(props, ref) {
