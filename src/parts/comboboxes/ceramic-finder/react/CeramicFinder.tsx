...
export type CeramicFinderProps = FoundationProps;
/** Ceramic Finder: Aタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, CeramicFinderProps>(function CeramicFinder(props, ref) {
