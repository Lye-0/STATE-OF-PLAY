...
export type CompactFinderProps = FoundationProps;
/** Compact Finder: Bタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, CompactFinderProps>(function CompactFinder(props, ref) {
