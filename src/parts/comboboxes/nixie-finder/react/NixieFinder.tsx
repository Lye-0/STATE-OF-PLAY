...
export type NixieFinderProps = FoundationProps;
/** Nixie Finder: Aタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, NixieFinderProps>(function NixieFinder(props, ref) {
