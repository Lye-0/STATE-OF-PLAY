...
export type RelayFinderProps = FoundationProps;
/** Relay Finder: Aタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, RelayFinderProps>(function RelayFinder(props, ref) {
