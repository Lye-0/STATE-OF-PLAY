...
export type TideFinderProps = FoundationProps;
/** Tide Finder: Aタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, TideFinderProps>(function TideFinder(props, ref) {
