...
export type IrisBloomLoaderProps=FoundationProps;
export default forwardRef<HTMLDivElement,IrisBloomLoaderProps>(function IrisBloomLoader(props,ref){
