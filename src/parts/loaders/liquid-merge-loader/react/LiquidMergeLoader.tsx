...
export type LiquidMergeLoaderProps=FoundationProps;
export default forwardRef<HTMLDivElement,LiquidMergeLoaderProps>(function LiquidMergeLoader(props,ref){
