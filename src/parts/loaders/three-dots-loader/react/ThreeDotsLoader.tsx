...
export type ThreeDotsLoaderProps=FoundationProps;
export default forwardRef<HTMLDivElement,ThreeDotsLoaderProps>(function ThreeDotsLoader(props,ref){
