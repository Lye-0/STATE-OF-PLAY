...
export type CornerTraceLoaderProps=FoundationProps;
export default forwardRef<HTMLDivElement,CornerTraceLoaderProps>(function CornerTraceLoader(props,ref){
