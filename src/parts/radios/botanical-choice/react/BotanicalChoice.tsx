...
export type BotanicalChoiceProps = FoundationProps;
/** Botanical Choice: Aタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, BotanicalChoiceProps>(function BotanicalChoice(props, ref) {
