...
export type BlueprintChoiceProps = FoundationProps;
/** Blueprint Choice: Aタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, BlueprintChoiceProps>(function BlueprintChoice(props, ref) {
