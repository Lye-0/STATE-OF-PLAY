...
export type NixieChoiceProps = FoundationProps;
/** Nixie Choice: Aタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, NixieChoiceProps>(function NixieChoice(props, ref) {
