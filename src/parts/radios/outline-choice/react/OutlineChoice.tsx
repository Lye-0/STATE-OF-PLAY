...
export type OutlineChoiceProps = FoundationProps;
/** Outline Choice: Bタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, OutlineChoiceProps>(function OutlineChoice(props, ref) {
