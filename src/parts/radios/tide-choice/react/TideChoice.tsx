...
export type TideChoiceProps = FoundationProps;
/** Tide Choice: Aタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, TideChoiceProps>(function TideChoice(props, ref) {
