...
export type ObsidianChoiceProps = FoundationProps;
/** Obsidian Choice: Aタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, ObsidianChoiceProps>(function ObsidianChoice(props, ref) {
