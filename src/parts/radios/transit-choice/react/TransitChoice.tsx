...
export type TransitChoiceProps = FoundationProps;
/** Transit Choice: Aタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, TransitChoiceProps>(function TransitChoice(props, ref) {
