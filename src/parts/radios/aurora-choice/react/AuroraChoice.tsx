...
export type AuroraChoiceProps = FoundationProps;
/** Aurora Choice: Aタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, AuroraChoiceProps>(function AuroraChoice(props, ref) {
