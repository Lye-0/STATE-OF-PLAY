...
export type CeramicChoiceProps = FoundationProps;
/** Ceramic Choice: Aタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, CeramicChoiceProps>(function CeramicChoice(props, ref) {
