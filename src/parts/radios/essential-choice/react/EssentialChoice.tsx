...
export type EssentialChoiceProps = FoundationProps;
/** Essential Choice: Bタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, EssentialChoiceProps>(function EssentialChoice(props, ref) {
