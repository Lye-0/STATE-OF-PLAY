...
export type SlateChoiceProps = FoundationProps;
/** Slate Choice: Bタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, SlateChoiceProps>(function SlateChoice(props, ref) {
