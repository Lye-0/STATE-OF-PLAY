...
export type ContourChoiceProps = FoundationProps;
/** Contour Choice: Aタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, ContourChoiceProps>(function ContourChoice(props, ref) {
