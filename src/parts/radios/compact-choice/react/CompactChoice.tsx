...
export type CompactChoiceProps = FoundationProps;
/** Compact Choice: Bタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, CompactChoiceProps>(function CompactChoice(props, ref) {
