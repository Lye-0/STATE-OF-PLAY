...
export type RelayChoiceProps = FoundationProps;
/** Relay Choice: Aタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, RelayChoiceProps>(function RelayChoice(props, ref) {
