...
export type InsetChoiceProps = FoundationProps;
/** Inset Choice: Bタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, InsetChoiceProps>(function InsetChoice(props, ref) {
