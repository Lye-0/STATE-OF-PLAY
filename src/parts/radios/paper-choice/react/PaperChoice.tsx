...
export type PaperChoiceProps = FoundationProps;
/** Paper Choice: Bタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, PaperChoiceProps>(function PaperChoice(props, ref) {
