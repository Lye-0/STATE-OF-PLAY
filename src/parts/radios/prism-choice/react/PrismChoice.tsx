...
export type PrismChoiceProps = FoundationProps;
/** Prism Choice: Aタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, PrismChoiceProps>(function PrismChoice(props, ref) {
