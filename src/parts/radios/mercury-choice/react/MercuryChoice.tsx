...
export type MercuryChoiceProps = FoundationProps;
/** Mercury Choice: Aタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, MercuryChoiceProps>(function MercuryChoice(props, ref) {
