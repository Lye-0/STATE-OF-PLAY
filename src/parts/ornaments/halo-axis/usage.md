...
`HaloAxis.tsx` を import して配置します。

```tsx
import HaloAxis from './HaloAxis';

export default function Example() {
  return <HaloAxis paused={false} />;
}
```
...
const element = document.querySelector<HTMLElement>('[data-ornament="halo-axis"]');
if (element) {
