...
export type MercuryPagesProps = FoundationProps;
/** Mercury Pages: Aタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, MercuryPagesProps>(function MercuryPages(props, ref) {
