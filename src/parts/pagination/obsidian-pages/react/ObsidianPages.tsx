...
export type ObsidianPagesProps = FoundationProps;
/** Obsidian Pages: Aタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, ObsidianPagesProps>(function ObsidianPages(props, ref) {
