...
/** 二本の磨いたレールがつまみの周囲だけ滑らかに開く。通過した場所は一本の継ぎ目へ戻る。 */
export default function SplitRailScrollArea(props: ScrollAreaProps) {
  ...
  const {root, viewportId} = useKineticScroll('split',props);
  return <div {...attributes} ref={root} className={`sop-scroll-area sop-kinetic-scroll sop-split-rail ${className}`} data-orientation={orientation}>
