...
import LacquerScrollScrollArea from './LacquerScrollScrollArea';
/** Replace this sample content with your own. Keep a constrained viewport height. */
export default function Example() {
  return <LacquerScrollScrollArea style={{height: 320, maxWidth: 480}} viewportLabel="ドキュメント">
