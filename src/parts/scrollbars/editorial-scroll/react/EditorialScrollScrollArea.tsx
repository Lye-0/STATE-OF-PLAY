...
/** 紙のような余白に、小さな目印を添える。 Native scroll content with a skinned, proportional rail. */
export default function EditorialScrollScrollArea(props: ScrollAreaProps) {
  ...
  return <div {...attributes} ref={root} className={`sop-scroll-area sop-editorial-scroll ${className}`} data-orientation={orientation}>
