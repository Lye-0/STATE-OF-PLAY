...
import EditorialScrollScrollArea from './EditorialScrollScrollArea';
/** Replace this sample content with your own. Keep a constrained viewport height. */
export default function Example() {
  return <EditorialScrollScrollArea style={{height: 320, maxWidth: 480}} viewportLabel="ドキュメント">
