...
/** 結晶のつまみが通った場所にだけ分光色が現れ、短い余韻のあと透明へ戻る。 */
export default function SpectralWakeScrollArea(props: ScrollAreaProps) {
  ...
  const {root, viewportId} = useKineticScroll('spectral',props);
  return <div {...attributes} ref={root} className={`sop-scroll-area sop-kinetic-scroll sop-spectral-wake ${className}`} data-orientation={orientation}>
