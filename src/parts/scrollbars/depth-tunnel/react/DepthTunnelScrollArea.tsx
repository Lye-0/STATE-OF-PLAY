...
export default function DepthTunnelScrollArea(props: ScrollAreaProps) {
  ...
  const {root, viewportId} = useKineticScroll('tunnel',props);
  return <div {...attributes} ref={root} className={`sop-scroll-area sop-kinetic-scroll sop-depth-tunnel ${className}`} data-orientation={orientation}>
