...
/** 四本の張った線がつまみ付近で波打つ。速く動かすほど振幅が増え、止めると収束する。 */
export default function WaveRailScrollArea(props: ScrollAreaProps) {
  ...
  const {root, viewportId} = useKineticScroll('wave',props);
  return <div {...attributes} ref={root} className={`sop-scroll-area sop-kinetic-scroll sop-wave-rail ${className}`} data-orientation={orientation}>
