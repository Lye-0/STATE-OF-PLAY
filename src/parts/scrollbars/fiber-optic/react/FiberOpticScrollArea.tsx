...
/** 七本の細い光路が束になり、動かした瞬間だけ光の粒が順番に走り抜ける。 */
export default function FiberOpticScrollArea(props: ScrollAreaProps) {
  ...
  const {root, viewportId} = useKineticScroll('fiber',props);
  return <div {...attributes} ref={root} className={`sop-scroll-area sop-kinetic-scroll sop-fiber-optic ${className}`} data-orientation={orientation}>
