...
import PaperRibbonScrollArea from './PaperRibbonScrollArea';
/** Replace this sample content with your own. Keep a constrained viewport height. */
export default function Example() {
  return <PaperRibbonScrollArea style={{height: 320, maxWidth: 480}} viewportLabel="ドキュメント">
