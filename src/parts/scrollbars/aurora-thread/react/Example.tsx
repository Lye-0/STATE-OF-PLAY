...
import AuroraThreadScrollArea from './AuroraThreadScrollArea';
/** Replace this sample content with your own. Keep a constrained viewport height. */
export default function Example() {
  return <AuroraThreadScrollArea style={{height: 320, maxWidth: 480}} viewportLabel="ドキュメント">
