...
import SoftScrollScrollArea from './SoftScrollScrollArea';
/** Replace this sample content with your own. Keep a constrained viewport height. */
export default function Example() {
  return <SoftScrollScrollArea style={{height: 320, maxWidth: 480}} viewportLabel="ドキュメント">
