...
export default function SoftScrollScrollArea(props: ScrollAreaProps) {
  ...
  return <div {...attributes} ref={root} className={`sop-scroll-area sop-soft-scroll ${className}`} data-orientation={orientation}>
