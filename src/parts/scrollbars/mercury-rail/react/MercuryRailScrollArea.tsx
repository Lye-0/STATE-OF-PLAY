...
/** 液体金属の首がつまみに吸い付き、速度に応じて伸びる。移動位置は遅延させない。 */
export default function MercuryRailScrollArea(props: ScrollAreaProps) {
  ...
  const {root, viewportId} = useKineticScroll('mercury',props);
  return <div {...attributes} ref={root} className={`sop-scroll-area sop-kinetic-scroll sop-mercury-rail ${className}`} data-orientation={orientation}>
