...
/** 白いページを引き締める、明快なモノクローム。 Native scroll content with a skinned, proportional rail. */
export default function InkScrollScrollArea(props: ScrollAreaProps) {
  ...
  return <div {...attributes} ref={root} className={`sop-scroll-area sop-ink-scroll ${className}`} data-orientation={orientation}>
