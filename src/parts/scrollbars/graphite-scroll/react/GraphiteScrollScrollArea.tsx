...
/** ダークな管理画面に似合う、精密なマットグレー。 Native scroll content with a skinned, proportional rail. */
export default function GraphiteScrollScrollArea(props: ScrollAreaProps) {
  ...
  return <div {...attributes} ref={root} className={`sop-scroll-area sop-graphite-scroll ${className}`} data-orientation={orientation}>
