...
import GraphiteScrollScrollArea from './GraphiteScrollScrollArea';
/** Replace this sample content with your own. Keep a constrained viewport height. */
export default function Example() {
  return <GraphiteScrollScrollArea style={{height: 320, maxWidth: 480}} viewportLabel="ドキュメント">
