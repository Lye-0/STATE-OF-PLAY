...
export default function MinimalScrollScrollArea(props: ScrollAreaProps) {
  ...
  return <div {...attributes} ref={root} className={`sop-scroll-area sop-minimal-scroll ${className}`} data-orientation={orientation}>
