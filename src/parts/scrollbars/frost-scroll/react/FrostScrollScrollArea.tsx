...
/** 淡い青の光を、使いやすい細い形に。 Native scroll content with a skinned, proportional rail. */
export default function FrostScrollScrollArea(props: ScrollAreaProps) {
  ...
  return <div {...attributes} ref={root} className={`sop-scroll-area sop-frost-scroll ${className}`} data-orientation={orientation}>
