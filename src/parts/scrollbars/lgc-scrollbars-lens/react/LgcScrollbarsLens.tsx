...
/** 細く、見つけやすく。日常の画面になじむニュートラルな一本。 Native scroll content with a skinned, proportional rail. */
export default function LgcScrollbarsLens(props: ScrollAreaProps) {
  ...
  return <div {...attributes} ref={root} className={`sop-scroll-area lgc-root sop-lgc-scrollbars-lens ${className}`} data-orientation={orientation}>
