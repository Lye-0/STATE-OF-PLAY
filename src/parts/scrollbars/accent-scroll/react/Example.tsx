...
import AccentScrollScrollArea from './AccentScrollScrollArea';
/** Replace this sample content with your own. Keep a constrained viewport height. */
export default function Example() {
  return <AccentScrollScrollArea style={{height: 320, maxWidth: 480}} viewportLabel="ドキュメント">
