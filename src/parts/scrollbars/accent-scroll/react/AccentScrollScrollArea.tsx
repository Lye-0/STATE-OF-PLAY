...
/** 読みやすい白い画面に、端正な青いスクロールバー。 Native scroll content with a skinned, proportional rail. */
export default function AccentScrollScrollArea(props: ScrollAreaProps) {
  ...
  return <div {...attributes} ref={root} className={`sop-scroll-area sop-accent-scroll ${className}`} data-orientation={orientation}>
