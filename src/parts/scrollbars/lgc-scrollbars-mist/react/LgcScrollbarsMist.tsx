...
/** 穏やかな丸みと、ほんの少しの立体感。 Native scroll content with a skinned, proportional rail. */
export default function LgcScrollbarsMist(props: ScrollAreaProps) {
  ...
  return <div {...attributes} ref={root} className={`sop-scroll-area lgc-root sop-lgc-scrollbars-mist ${className}`} data-orientation={orientation}>
