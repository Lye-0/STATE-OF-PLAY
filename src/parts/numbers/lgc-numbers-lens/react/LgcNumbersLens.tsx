...
export type LgcNumbersLensProps = FoundationProps;
/** Lens Stepper: Bタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, LgcNumbersLensProps>(function LgcNumbersLens(props, ref) {
