...
export type TransitRangeProps = FoundationProps;
/** Transit Range: Aタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, TransitRangeProps>(function TransitRange(props, ref) {
