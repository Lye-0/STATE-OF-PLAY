...
export type VelvetRangeProps = FoundationProps;
/** Velvet Range: Aタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, VelvetRangeProps>(function VelvetRange(props, ref) {
