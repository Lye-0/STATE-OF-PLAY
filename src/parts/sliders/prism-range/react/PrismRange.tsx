...
export type PrismRangeProps = FoundationProps;
/** Prism Range: Aタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, PrismRangeProps>(function PrismRange(props, ref) {
