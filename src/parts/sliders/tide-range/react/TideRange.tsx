...
export type TideRangeProps = FoundationProps;
/** Tide Range: Aタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, TideRangeProps>(function TideRange(props, ref) {
