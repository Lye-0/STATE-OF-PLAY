...
export type LgcHintsLensProps = FoundationProps;
/** Lens Hint: Bタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, LgcHintsLensProps>(function LgcHintsLens(props, ref) {
