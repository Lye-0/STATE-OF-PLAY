...
styles.css/popup-base.css/popup-content.cssの色・寸法・余白・輪郭・文字組みと、examples内の内容構成を正本にする。ベース#14262e、本文#edf5f6、アクセント#b5e8e0。意図は「光の向こうへ。」。枠だけではなく内部のprismatic / windowの情報表現も維持する。
