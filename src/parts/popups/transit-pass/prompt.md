# Transit Pass — 再現仕様
出発地と到着地を結ぶ、チケット型のポップアップ。

styles.css/popup-base.css/popup-content.cssの色・寸法・余白・輪郭・文字組みと、examples内の内容構成を正本にする。ベース#d2d6c8、本文#283a32、アクセント#47654a。意図は「次の場所へ。」。枠だけではなく内部のtravel / boardingの情報表現も維持する。
