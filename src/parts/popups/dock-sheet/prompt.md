# Dock Sheet — 再現仕様
下から浮かび上がる、ゆとりのある設定シート。

styles.css/popup-base.css/popup-content.cssの色・寸法・余白・輪郭・文字組みと、examples内の内容構成を正本にする。ベース#22313a、本文#e1edf4、アクセント#a7cedf。意図は「下から、そっと。」。枠だけではなく内部のdock / sheetの情報表現も維持する。
