# Velvet Invitation — 再現仕様
深い布の背景と金の縁取りで見せる招待。

styles.css/popup-base.css/popup-content.cssの色・寸法・余白・輪郭・文字組みと、examples内の内容構成を正本にする。ベース#2b2335、本文#f0e3ed、アクセント#dfc295。意図は「特別な、招待状。」。枠だけではなく内部のvelvet / invitationの情報表現も維持する。
