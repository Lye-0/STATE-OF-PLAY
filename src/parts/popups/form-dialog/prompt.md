# Form Dialog — 再現仕様
ラベルと余白を整えた、名前とメールの入力例。

styles.css/popup-base.css/popup-content.cssの色・寸法・余白・輪郭・文字組みと、examples内の内容構成を正本にする。ベース#f0efeb、本文#333d3b、アクセント#4e7269。意図は「入力に、集中する。」。枠だけではなく内部のform / detailsの情報表現も維持する。
