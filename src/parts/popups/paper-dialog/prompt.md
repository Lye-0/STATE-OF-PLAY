...
styles.css/popup-base.css/popup-content.cssの色・寸法・余白・輪郭・文字組みと、examples内の内容構成を正本にする。ベース#f2f2ec、本文#2e3e35、アクセント#416b54。意図は「明るい画面の、確認欄。」。枠だけではなく内部のpaper / formの情報表現も維持する。
