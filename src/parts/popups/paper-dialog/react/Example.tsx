...
export default function Example(){
  ...
  return <PaperDialog title="名前を変更" description="新しい表示名を入力してください。" kicker="EDIT DETAILS" triggerLabel="Open Paper Dialog" open={open} onOpenChange={setOpen} confirmLabel="変更する" cancelLabel="キャンセル">
