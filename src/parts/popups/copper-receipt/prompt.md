# Copper Receipt — 再現仕様
銅の光とレシートの細い罫線で、情報を整理。

styles.css/popup-base.css/popup-content.cssの色・寸法・余白・輪郭・文字組みと、examples内の内容構成を正本にする。ベース#38281e、本文#f4e0c6、アクセント#edc399。意図は「整えた、記録。」。枠だけではなく内部のcopper / recordの情報表現も維持する。
