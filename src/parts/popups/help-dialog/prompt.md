...
styles.css/popup-base.css/popup-content.cssの色・寸法・余白・輪郭・文字組みと、examples内の内容構成を正本にする。ベース#242b31、本文#e4edf2、アクセント#bdd3dc。意図は「次の一歩が、わかる。」。枠だけではなく内部のhelp / guidanceの情報表現も維持する。
