# Compact Dialog — 再現仕様
短い選択や通知を伝えるためのコンパクトな窓。

styles.css/popup-base.css/popup-content.cssの色・寸法・余白・輪郭・文字組みと、examples内の内容構成を正本にする。ベース#282a2e、本文#e9eaf0、アクセント#c9c7df。意図は「小さく、十分に。」。枠だけではなく内部のcompact / utilityの情報表現も維持する。
