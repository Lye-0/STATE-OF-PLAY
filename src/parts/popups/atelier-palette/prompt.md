# Atelier Palette — 再現仕様
絵の具見本のような色面と、実際に選べるパレット。

styles.css/popup-base.css/popup-content.cssの色・寸法・余白・輪郭・文字組みと、examples内の内容構成を正本にする。ベース#e8d9c7、本文#4d3d36、アクセント#986b51。意図は「色を、選ぶ時間。」。枠だけではなく内部のpigment / selectionの情報表現も維持する。
