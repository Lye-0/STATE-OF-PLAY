# Opal Window — 再現仕様
オパールの干渉色と、柔らかな紹介のカード。

styles.css/popup-base.css/popup-content.cssの色・寸法・余白・輪郭・文字組みと、examples内の内容構成を正本にする。ベース#e1dde9、本文#49435e、アクセント#806d9d。意図は「淡く、知らせる。」。枠だけではなく内部のpearlescent / noteの情報表現も維持する。
