# Folio Window — 再現仕様
紙の余白と活版のような文字組みのポップアップ。

styles.css/popup-base.css/popup-content.cssの色・寸法・余白・輪郭・文字組みと、examples内の内容構成を正本にする。ベース#e7e0cf、本文#3d392d、アクセント#586146。意図は「ページを、めくる。」。枠だけではなく内部のpaper / editorialの情報表現も維持する。
