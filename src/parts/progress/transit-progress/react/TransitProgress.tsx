...
export type TransitProgressProps = FoundationProps;
/** Transit Progress: Aタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, TransitProgressProps>(function TransitProgress(props, ref) {
