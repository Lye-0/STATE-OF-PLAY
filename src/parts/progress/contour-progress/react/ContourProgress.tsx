...
export type ContourProgressProps = FoundationProps;
/** Contour Progress: Aタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, ContourProgressProps>(function ContourProgress(props, ref) {
