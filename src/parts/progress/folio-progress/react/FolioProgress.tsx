...
export type FolioProgressProps = FoundationProps;
/** Folio Progress: Aタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, FolioProgressProps>(function FolioProgress(props, ref) {
