...
export type ApertureProgressProps = FoundationProps;
/** Aperture Progress: Aタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, ApertureProgressProps>(function ApertureProgress(props, ref) {
