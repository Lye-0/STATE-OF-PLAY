...
export type LgcToastsLensProps = FoundationProps;
/** Floating Notice: Bタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, LgcToastsLensProps>(function LgcToastsLens(props, ref) {
