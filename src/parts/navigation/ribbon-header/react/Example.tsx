...
const initial: RibbonHeaderProps = {
  "label": "ワークスペース",
  "brand": "Fieldwork",
  "items": [
    {
...
export default function Example() {
 ...
 return <><RibbonHeader {...initial} active={active} onActiveChange={setActive}/><section id="destination"><h2>移動先</h2><p>hrefを実際のルートへ変更してください。</p></section></>;
}
