# Essential Check — 再現仕様
日常のフォームになじむ、ニュートラルなチェック。

ルート.sop-essential-checkとsop-check、input[type=checkbox]、装飾用のbox/tick/dash、ラベル・補足のレイヤー構造を維持。styles.cssとcheckbox-base.cssを正本とし、ベース色#20252a、本文#ecf0ed、アクセント#b9d6c3を維持する。迷わず、選ぶ。 チェック線は描き込むように現れ、mixedは水平線で区別する。CSSだけの演出をCanvasや常時RAFに置き換えない。
