# Paperfold Check — 再現仕様
折り目と紙の厚みを感じる、温かい選択。

ルート.sop-paperfold-checkとsop-check、input[type=checkbox]、装飾用のbox/tick/dash、ラベル・補足のレイヤー構造を維持。styles.cssとcheckbox-base.cssを正本とし、ベース色#dfc6a3、本文#3e2e21、アクセント#563e24を維持する。ひと折りの、意思。 チェック線は描き込むように現れ、mixedは水平線で区別する。CSSだけの演出をCanvasや常時RAFに置き換えない。
