...
export function init(root:HTMLElement,options:SimpleToggleOptions&GlassOptions={}){return mountGlassToggle(root,config,{material:'regular',appearance:'dark',...options});}
