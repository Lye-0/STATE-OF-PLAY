...
export type SlateTagsProps = FoundationProps;
/** Slate Tags: Bタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, SlateTagsProps>(function SlateTags(props, ref) {
