...
export type PrismTagsProps = FoundationProps;
/** Prism Tags: Aタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, PrismTagsProps>(function PrismTags(props, ref) {
