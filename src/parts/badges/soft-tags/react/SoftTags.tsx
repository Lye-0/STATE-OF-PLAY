...
export type SoftTagsProps = FoundationProps;
/** Soft Tags: Bタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, SoftTagsProps>(function SoftTags(props, ref) {
