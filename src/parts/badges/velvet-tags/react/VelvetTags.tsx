...
export type VelvetTagsProps = FoundationProps;
/** Velvet Tags: Aタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, VelvetTagsProps>(function VelvetTags(props, ref) {
