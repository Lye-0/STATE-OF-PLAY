...
export type TideTagsProps = FoundationProps;
/** Tide Tags: Aタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, TideTagsProps>(function TideTags(props, ref) {
