...
export type FolioTagsProps = FoundationProps;
/** Folio Tags: Aタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, FolioTagsProps>(function FolioTags(props, ref) {
