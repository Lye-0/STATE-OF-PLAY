...
export type LgcBadgesLensProps = FoundationProps;
/** Glass Tokens: Bタイプ。元の外観と、ネイティブ操作を保つ独立したDOM領域。 */
export default forwardRef<HTMLDivElement, LgcBadgesLensProps>(function LgcBadgesLens(props, ref) {
