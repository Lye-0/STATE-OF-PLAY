...
export type ApertureCalendarProps = FoundationProps;
/** Aperture Calendar: Aタイプ。元の外観と、独自の日時選択を備えた独立したDOM領域。 */
export default forwardRef<HTMLDivElement, ApertureCalendarProps>(function ApertureCalendar(props, ref) {
