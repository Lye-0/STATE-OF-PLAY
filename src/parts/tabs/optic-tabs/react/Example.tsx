...
export default function Example(){const[value,setValue]=useState('choice-1');return <OpticTabs items={items} value={value} onValueChange={setValue} aria-label="Optic Tabs"/>;}
