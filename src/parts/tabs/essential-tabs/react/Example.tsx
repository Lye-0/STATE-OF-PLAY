...
export default function Example(){const[value,setValue]=useState('choice-1');return <EssentialTabs items={items} value={value} onValueChange={setValue} aria-label="Essential Tabs"/>;}
