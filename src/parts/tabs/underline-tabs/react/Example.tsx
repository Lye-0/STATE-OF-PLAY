...
export default function Example(){const[value,setValue]=useState('choice-1');return <UnderlineTabs items={items} value={value} onValueChange={setValue} aria-label="Underline Tabs"/>;}
