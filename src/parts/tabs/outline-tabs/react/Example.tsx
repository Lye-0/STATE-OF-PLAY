...
export default function Example(){const[value,setValue]=useState('choice-1');return <OutlineTabs items={items} value={value} onValueChange={setValue} aria-label="Outline Tabs"/>;}
