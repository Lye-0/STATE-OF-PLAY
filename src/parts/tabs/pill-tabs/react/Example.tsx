...
export default function Example(){const[value,setValue]=useState('choice-1');return <PillTabs items={items} value={value} onValueChange={setValue} aria-label="Pill Tabs"/>;}
