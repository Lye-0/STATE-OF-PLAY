...
export default function Example(){const[value,setValue]=useState('choice-1');return <PrismTabs items={items} value={value} onValueChange={setValue} aria-label="Prism Tabs"/>;}
