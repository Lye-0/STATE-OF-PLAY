...
test('refinement keeps 564 parts; 16 A rails and 16 A selects; stable IDs',()=>{
 assert.equal(bases.length,564);assert.equal(A.length,32);assert.equal(new Set(bases).size,564);
