...
### src/parts/toggles/volt/react/VoltToggle.jsx
...
### src/parts/toggles/volt/react/Example.jsx
...
export default function Example() {
    ...
    return <VoltToggle checked={enabled} onCheckedChange={setEnabled} aria-label="通知を有効にする"/>;
}
