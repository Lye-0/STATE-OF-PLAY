...
### src/parts/blocks/frosted-glass/vanilla/init.ts
...
### src/parts/blocks/frosted-glass/vanilla/main.ts

```typescript
import { init } from './init';

const element = document.querySelector<HTMLElement>('.sop-frosted-glass');
if (!element) throw new Error('The Frosted Glass root was not found.');
...
### src/parts/blocks/frosted-glass/vanilla/index.html
