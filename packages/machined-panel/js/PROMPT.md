...
### src/parts/blocks/machined-panel/vanilla/init.js
...
### src/parts/blocks/machined-panel/vanilla/main.js

```javascript
import { init } from './init.js';
const element = document.querySelector('.sop-machined-panel');
if (!element)
    throw new Error('The Machined Panel root was not found.');
...
### src/parts/blocks/machined-panel/vanilla/index.html
