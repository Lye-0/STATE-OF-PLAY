...
### src/parts/blocks/original-surface/react/OriginalSurface.jsx
...
### src/parts/blocks/original-surface/styles.css
...
### src/parts/blocks/original-surface/react/Example.jsx

```jsx
import React from 'react';
import OriginalSurface from './OriginalSurface';
export default function Example() {
    return <OriginalSurface style={{ maxWidth: 420 }}>
...
### src/parts/blocks/original-surface/markup.html
