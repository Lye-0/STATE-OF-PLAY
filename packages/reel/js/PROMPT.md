...
### src/parts/toggles/reel/vanilla/init.js
...
### src/parts/toggles/reel/vanilla/main.js

```javascript
import { init } from './init.js';
const element = document.querySelector('.sop-reel');
if (!element)
    throw new Error('The Analog root was not found.');
