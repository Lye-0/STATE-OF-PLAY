...
### src/parts/toggles/reel/vanilla/init.ts
...
### src/parts/toggles/reel/vanilla/main.ts

```typescript
import { init } from './init';

const element = document.querySelector<HTMLElement>('.sop-reel');
if (!element) throw new Error('The Analog root was not found.');
...
### src/parts/toggles/reel/vanilla/index.html
