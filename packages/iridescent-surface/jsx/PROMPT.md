...
### src/parts/blocks/iridescent-surface/react/IridescentSurface.jsx
...
### src/parts/blocks/iridescent-surface/react/Example.jsx

```jsx
import React from 'react';
import IridescentSurface from './IridescentSurface';
export default function Example() {
    return <IridescentSurface style={{ maxWidth: 420 }}>
